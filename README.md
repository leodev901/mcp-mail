...
- 관련 코드 경로는 `app/core/token_manager.py`, `app/routes/m365_oauth.py`, `cmn/api/endpoint/auth_router.py`, `cmn/services/delegated_auth_service.py`, `cmn/utils/jwt_manager.py` 입니다.
